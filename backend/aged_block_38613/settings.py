"""
Django settings for aged_block_38613 project.
...
ROOT_URLCONF = 'aged_block_38613.urls'
...
WSGI_APPLICATION = 'aged_block_38613.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_block_38613 API",
    "DESCRIPTION": "API documentation for aged_block_38613 App",
    "VERSION": "v1",
}
